    ...
    <Tag tag='section' inMotion={false} className='py-10 sm:py-20' id={id}>
      <div className='mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
        <div className='lg:pr-4'>
          <div
            className='relative overflow-hidden rounded-3xl bg-primary px-6 pt-64 pb-9 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10
              xl:pb-10'
          >
            <Image
              alt='cover'
            ...
            <figure className='relative isolate'>
              ...
              <blockquote className='mt-6'>
                <Text variant='primary' className='text-white'>
                  Наша миссия — объединять людей ради добра.
                </Text>
              </blockquote>
              <figcaption className='mt-6 text-sm/6 text-gray-300'>
                <strong className='font-semibold text-white'>Judith Rogers,</strong> CEO в Голос за добро
              </figcaption>
            </figure>
          </div>
        </div>
        <div>
          <div className='lg:max-w-lg'>
            <Title level='1' variant='tertiary' className='mt-2'>
              Объединяем, чтобы менять мир
            </Title>
            <div className='max-w-xl'>
              <Text variant='secondary' className='mt-6'>
                Мы — команда единомышленников, которые верят, что маленькие добрые дела способны менять мир.
              </Text>
              <Text variant='secondary' className='mt-8'>
                Каждый из нас вносит свою уникальную лепту — идеи, опыт, энергию — чтобы создавать проекты,
                вдохновляющие на перемены.
              </Text>
              <Text variant='secondary' className='mt-8'>
                Вместе мы строим сообщество, где ценят искренность, поддержку и желание сделать жизнь лучше.
              </Text>
            </div>
          </div>
          ...
          <div className='mt-10 flex'>
            <LearnMore href={`#${SYSTEM_ROUTES.NOMINANTS}`} />
          </div>
        </div>
      </div>
    </Tag>
