    ...
    <Tag tag='section' inMotion={false} className='py-10 sm:py-20' id={id}>
      <div className='mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
        <div className='lg:pr-4'>
          <div
            className='relative h-124 overflow-hidden rounded-3xl bg-primary px-6 pt-64 pb-9 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8
              xl:px-10 xl:pb-10'
          >
            <Image
              alt='cover'
            ...
            <figure className='relative isolate'>
              <svg
                ...
                viewBox='0 0 162 128'
                aria-hidden='true'
                className='absolute top-20 -left-2 -z-10 h-32 stroke-white/20'
              >
                <path
              ...
              <blockquote className='absolute top-30 z-10'>
                <Text variant='primary' className='text-white'>
                  Наша миссия — помогать, поддерживать и вдохновлять.
                </Text>
              </blockquote>
            </figure>
          </div>
        ...
        <div>
          <div className='lg:max-w-lg'>
            <Title level='1' variant='tertiary' className='mt-2'>
              Мы объединяем ради добра
            </Title>
            <div className='max-w-xl'>
              <Text variant='secondary' className='mt-6'>
                Наш фонд — это пространство, где рождается надежда. Мы верим: в каждом человеке есть сила менять жизнь к
                лучшему.
              </Text>
              ...
              <Text variant='secondary' className='mt-8'>
                Конкурс — наш способ услышать твой голос и сделать его заметным.
              </Text>
            </div>
          </div>
          ...
          <div className='mt-10 flex'>
            <LearnMore href={`#${SYSTEM_ROUTES.NOMINANTS}`} text='Узнать о конкурсе' />
          </div>
        </div>
      </div>
    </Tag>
