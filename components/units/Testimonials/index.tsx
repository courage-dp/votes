  ...
  return (
    <Tag tag='section' id={id} className='isolate overflow-hidden px-6 lg:px-8'>
      <div className='relative mx-auto max-w-2xl py-10 sm:py-20 lg:max-w-4xl'>
        ...
        />
        <div
          className='absolute inset-y-0 right-1/2 -z-10 mr-12 w-[150vw] origin-bottom-left skew-x-[-30deg] bg-primary shadow-xl
            shadow-indigo-600/10 ring-secondary sm:mr-20 md:mr-0 lg:right-full lg:-mr-36 lg:origin-center'
        />
        <figure className='grid grid-cols-1 items-end gap-x-6 gap-y-8 lg:gap-x-10'>
          <div className='relative col-span-2 xl:col-start-1 xl:row-start-2'>
            <svg
              fill='none'
              viewBox='0 0 162 128'
              aria-hidden='true'
              className='absolute -top-12 left-0 -z-10 h-32 stroke-secondary/10'
            >
              <path
            ...
            <blockquote>
              <Title level='4' variant='tertiary'>
          ...
          <div className='col-end-1 flex-1 xl:row-span-4'>
            <Image
              alt='testimonial'
              ...
              className='size-80 rounded-xl bg-indigo-50 lg:size-100 lg:rounded-3xl xl:size-120'
            />
            <figcaption className='mt-5 text-base xl:col-start-1 xl:row-start-3'>
              <div className='font-semibold text-secondary'>Judith Black</div>
              <div className='mt-1 text-secondary'>CEO of Workcation</div>
            </figcaption>
          </div>
        </figure>
      </div>
